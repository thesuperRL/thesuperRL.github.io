...
const currentIterationSongValue = getRandomInt(songList.length);

var app = (function () {
  var artist = "Project Sekai [FIXED BUT SCUFFED]";
  var twitter = "pupdecchan";
  var startDate = "2022-09-21";
  const Cn = ue([
    ...
    return {
      c() {
        (n = w("div")),
          ...
          (l = w("p")),
          (l.textContent =
            "oh no! seems like today's track is unavailable on\n                            soundcloud in your location. time to pack your bags and go on a trip ✈️ 🚶‍♀️"),
          (u = x()),
          c && c.c(),
          M(i, "class", "mr-3"),
          M(l, "class", "text-sm "),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _(
          "WONDERHOY! You got today's " + artist + " heardle within the first "
        )),
          (n = _(s)),
          (r = _(
            " seconds. Come back tomorrow for the next song! ૮ ˶ᵔ ᵕ ᵔ˶ ა"
          ));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("WONDERHOY! You got today's " + artist + " heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _(". Come back tomorrow for the next song! ૮ ˶ᵔ ᵕ ᵔ˶ ა"));
      },
      m(e, o) {
      ...
      c() {
        n = _(
          "You didn't get today's " +
            artist +
            " heardle. Now is the time to focus on practicing! Got it?"
        );
      },
      m(e, t) {
        g(e, n, t);
      ...
      c() {
        (t = w("meta")),
          ...
          M(
            ...
            "Guess the " +
              artist +
              " song from the intro in as few tries as possible (Romaji names only!)"
          ),
  ...
  function jn(e, t, n) {
    ...
    function x(e) {
      return currentIterationSongValue;
    }
