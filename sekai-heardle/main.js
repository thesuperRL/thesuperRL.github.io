...
const order = [111, 61, 120, 97, 63, 67, 100, 11, 21, 75, 140, 153, 144, 92, 141, 23, 43, 129, 136, 16, 151, 38, 27, 74, 132, 3, 80, 26, 62, 137, 134, 118, 40, 25, 79, 78, 49, 131, 17, 10, 64, 28, 148, 35, 154, 29, 46, 110, 73, 99, 18, 12, 51, 50, 101, 7, 32, 36, 48, 94, 59, 56, 105, 9, 60, 104, 19, 14, 139, 123, 34, 108, 24, 72, 58, 91, 149, 133, 6, 70, 109, 77, 39, 30, 146, 138, 8, 119, 69, 107, 143, 126, 115, 22, 106, 66, 147, 44, 85, 98, 76, 52, 117, 130, 135, 37, 13, 93, 155, 71, 15, 47, 86, 113, 57, 102, 0, 124, 68, 2, 20, 42, 142, 55, 122, 112, 150, 103, 121, 4, 89, 84, 145, 90, 95, 152, 81, 65, 96, 5, 125, 54, 33, 88, 82, 114, 45, 128, 127, 83, 41, 53, 87, 1, 116, 31];
...
var app = (function () {
  ...
  checkingDate = checkingDate.setDate(
    initialDate.getDate() + ArrGuesses.length
  );
  const Vt = {
  ...
  const Cn = ue(ArrGuesses),
    On = {
      subscribe: ue(dict, Pn).subscribe,
    };
  var Pn;
